...
import { NavLink } from 'react-router-dom';
 ...
 const navItems = [
      ...
      {to : '/ai/community' , label: 'Communtiy' , Icon: Users},
 ]
      ...
      <div className='my-7 w-full'>
        ...
        <div className='px-6 mt-5 text-sm text-gray-600 font-medium'>
            {navItems.map(({to , label , Icon})=>(
                <NavLink key={to}  to={to} end = {to === '/ai'} onClick={()=> setSidebar(false)} className={({isActive})=> `px-3.5 py-2.5 flex items-center gap-3
